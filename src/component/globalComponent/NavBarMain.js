                ...
                <List component="nav">
                    <Link to={"/?rdr=true"}>
                        ...
                        <ListItemIcon>
                            ...
                            <ListItemText className='dark-text' primary="Get Started" />
                    </ListItem>
                    </Link>
                    {/*<ListItem button>*/}
                        {/*<ListItemIcon>*/}
                    ...
                    <Link to={"/profile"}>
                        ...
                        <ListItemIcon>
                            ...
                            <ListItemText className='dark-text' primary="Profile" />
                    </ListItem>
                    </Link>
                    <Link to={"/github"}>
                        <ListItem button>
                        <ListItemIcon>
                            ...
                            <ListItemText className='dark-text' primary="Github" />
                    </ListItem>
                    </Link>
                    <Link to={"/design"}>
                        <ListItem button>
                            ...
                            <ListItemText className='dark-text' primary="Design" />
                        </ListItem>
                    </Link>
                    <Link to={"/cv"}>
                        <ListItem button>
                            ...
                            <ListItemText className='dark-text' primary="CV" />
                        </ListItem>
                    </Link>
                    <Link to={"/blogs"}>
                        <ListItem button>
                            ...
                            <ListItemText className='dark-text' primary="Blogs" />
                        </ListItem>
                    </Link>
                    <Link to={"/contribution"}>
                        <ListItem button>
                            ...
                            <ListItemText className='dark-text' primary="Open Source" />
                        </ListItem>
                    </Link>
                    <Link to={"/activity"}>
                        <ListItem button>
                            ...
                            <ListItemText className='dark-text' primary="Activity Tracker" />
                        </ListItem>
                    </Link>
                    ...
                    {/*</Link>*/}
                    <Link to={"/settings"}>
                        <ListItem className='dark-text' button>
                        <ListItemIcon>
                            <Icon>
                                settings
                            </Icon>
