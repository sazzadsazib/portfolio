...
import CVComponent from "./component/CV/CVComponent";
                ...
                <div>
                    <BrowserRouter>
                        <Switch>
                            ...
                            <Route  exact path='/cv' render={(props)=><CVComponent StalkingTime={this.state.StalkingTime} history={props.history}/>}/>
